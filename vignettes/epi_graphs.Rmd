...
These features allow users to analyze complex datasets without the need to waste time pre-processing data. For example, users can match graph titles and axis descriptions with their selected metrics and and filter for specific years, locations, or top contributors in just a few minutes.
...
EpiGraphs has pre-configured professional themes that are clean, minimalistic, and tailored for epidemiological presentations. 
...
```{r}
# Example: Top 10 locations with the highest syphilis cases in 2019
epi_bar_plot(
  ...
  period = 2019,              # Filter for the year 2022
