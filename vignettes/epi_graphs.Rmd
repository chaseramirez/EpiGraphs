...
```{r setup}
devtools::install_github("chaseramirez/EpiGraphs", force = TRUE)
library(EpiGraphs)
```
...
```{r}
# Example: Top 10 locations with the highest syphilis cases in 2018
epi_bar_plot(
  ...
  top_n = 5,               # Display top 10 locations
